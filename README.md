...
![Total](https://img.shields.io/badge/Total-2500-blue?style=flat-square) ![Stars](https://img.shields.io/badge/Stars-3523k%2B-yellow?style=flat-square) ![Today](https://img.shields.io/badge/Today-7-green?style=flat-square) ![Updated](https://img.shields.io/badge/Updated-2026-04-30-orange?style=flat-square)
...
|:-:|---------|---:|-------:|-------------|
| 1 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 126,094 | +1903 | The agent that grows with you |
| 2 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 56,289 | +1013 | A cross-platform desktop All-in-One assistant tool for Claud |
| 3 | [safishamsi/graphify](https://github.com/safishamsi/graphify) | 38,716 | +935 | AI coding assistant skill (Claude Code, Codex, OpenCode, Ope |
| 4 | [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) | 18,875 | +742 | Use claude-code for free in the terminal, VSCode extension o |
| 5 | [openclaw/openclaw](https://github.com/openclaw/openclaw) | 366,641 | +458 | Your own personal AI assistant. Any OS. Any Platform. The lo |
| 6 | [mksglu/context-mode](https://github.com/mksglu/context-mode) | 11,394 | +348 | Privacy-first. MCP is the protocol for tool access. We're th |
| 7 | [kepano/obsidian-skills](https://github.com/kepano/obsidian-skills) | 27,653 | +314 | Agent skills for Obsidian. Teach your agent to use Markdown, |
| 8 | [jau123/MeiGen-AI-Design-MCP](https://github.com/jau123/MeiGen-AI-Design-MCP) | 836 | +295 | MeiGen-AI-Design-MCP — Turn Claude Code / OpenClaw into your |
...
| 12 | [iOfficeAI/AionUi](https://github.com/iOfficeAI/AionUi) | 23,098 | +215 | Free, local, open-source 24/7 Cowork app and OpenClaw for Ge |
| 13 | [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) | 30,570 | +157 | A community collection of OpenClaw use cases for making life |
| 14 | [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) | 13,266 | +133 | 169 production-ready skills & plugins for Claude Code, OpenA |
| 15 | [chenhg5/cc-connect](https://github.com/chenhg5/cc-connect) | 6,849 | +129 | Bridge local AI coding agents (Claude Code, Cursor, Gemini C |
...
| 17 | [iOfficeAI/OfficeCLI](https://github.com/iOfficeAI/OfficeCLI) | 2,605 | +109 | OfficeCLI is the world's first and the best Office suite des |
...
| 19 | [espressif/esp-claw](https://github.com/espressif/esp-claw) | 811 | +96 | ESP-Claw, a Chat Coding AI agent framework for IoT devices |
...
- [🦞 Claw Variants](#claw-variants) (983)
...
<p align="center"><sub>✨ Auto-curated · 2026-04-30 20:26:00</sub></p>
