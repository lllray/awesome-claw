...
| 3 | [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage) | 57,717 | +567 | World's first open-source, agentic video productio... |
| 4 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 65,094 | +453 | Never stop coding. Free AI gateway: one endpoint, ... |
| 5 | [vastsa/PI-Desktop](https://github.com/vastsa/PI-Desktop) | 2,971 | +359 | Local-first AI coding agent desktop: Electron + Ru... |
...
| 8 | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 117,128 | +234 | AI coding assistant skill (Claude Code, Codex, Ope... |
...
| 11 | [FailproofAI/failproofai](https://github.com/FailproofAI/failproofai) | 2,926 | +197 | Observability and enforcement for AI agent harness... |
| 12 | [Untrivial-ai/agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator) | 11,715 | +192 | Run and supervise teams of coding agents from plan... |
| 13 | [mksglu/context-mode](https://github.com/mksglu/context-mode) | 22,276 | +176 | Privacy-first. MCP is the protocol for tool access... |
| 14 | [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) | 54,624 | +175 | Use claude-code for free in the terminal, VSCode e... |
| 15 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 95,707 | +167 | 🎨 Local-first, open-source alternative to Anthropi... |
| 16 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 132,472 | +155 | A cross-platform desktop All-in-One assistant tool... |
...
- [🖥️ 桌面 AI 助理](#desktop-assistant) (392)
- [🤖 Agent 助理](#agent-assistant) (507)
- [🔧 工具与 Skills](#tools-skills) (631)
- [📦 其他](#other) (681)
...
| [199-biotechnologies/claude-deep-research-skill](https://github.com/199-biotechnologies/claude-deep-research-skill) | 1,020 | Python | Enterprise-grade deep research skill for Claude Code with 8-phase pipe... |
...
<p align="center"><sub>✨ 自动整理 · 2026-09-12 20:39:41</sub></p>
