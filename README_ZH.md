...
| 2 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 64,641 | +799 | Never stop coding. Free AI gateway: one endpoint, ... |
| 3 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 228,794 | +578 | 随着你成长的代理人 |
| 4 | [vastsa/PI-Desktop](https://github.com/vastsa/PI-Desktop) | 2,612 | +535 | Local-first AI coding agent desktop: Electron + Ru... |
...
| 6 | [Untrivial-ai/agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator) | 11,523 | +332 | Run and supervise teams of coding agents from plan... |
| 7 | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 116,894 | +328 | AI coding assistant skill (Claude Code, Codex, Ope... |
...
| 10 | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 95,540 | +223 | 🎨 Local-first, open-source alternative to Anthropi... |
| 11 | [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) | 8,711 | +212 | A memory OS that makes your OpenClaw agents more p... |
| 12 | [mksglu/context-mode](https://github.com/mksglu/context-mode) | 22,100 | +211 | Privacy-first. MCP is the protocol for tool access... |
| 13 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 132,317 | +192 | A cross-platform desktop All-in-One assistant tool... |
| 14 | [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage) | 57,150 | +190 | World's first open-source, agentic video productio... |
| 15 | [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) | 54,449 | +150 | Use claude-code for free in the terminal, VSCode e... |
| 16 | [MemTensor/memmy-agent](https://github.com/MemTensor/memmy-agent) | 1,881 | +142 | 🍙  A personal AI agent & local memory hub for all ... |
...
| 19 | [FailproofAI/failproofai](https://github.com/FailproofAI/failproofai) | 2,729 | +116 | Observability and enforcement for AI agent harness... |
| 20 | [0xranx/OpenContext](https://github.com/0xranx/OpenContext) | 1,051 | +109 | A personal context store for AI agents and assista... |
...
- [🖥️ 桌面 AI 助理](#desktop-assistant) (391)
- [🤖 Agent 助理](#agent-assistant) (507)
- [🔧 工具与 Skills](#tools-skills) (629)
- [📦 其他](#other) (680)
...
<p align="center"><sub>✨ 自动整理 · 2026-09-11 20:43:41</sub></p>
